...
brca <- read.table("/home/yincy/git/data/ML/breast-cancer-wisconsin.data", 
                   sep = ",", 
                   header = F, 
                   na.strings = "?", 
                   col.names = cn, 
...
ce_kk %>% 
  ...
  geom_vline(xintercept = best_k, linetype = "dashed", linewidth = 0.3) +
  geom_hline(yintercept = min_ce, linetype = "dashed", linewidth = 0.3)
```
