...
text(x = 5, y = 5, labels = "Plot", col="red", cex=2)  
text(x = 5,y = 4, labels = "text(5,5, \"Plot\", col=\"red\", cex = 2)", col="red", cex=1)  
box(which = "plot", col="red") # which characterize where to draw the box, which can be 
# "plot", "figure", "inner" and "outer"

# Place text in the margins and label the margins, all in green  
mtext(text = "Margins", side=3, line=2, cex=2, col="green")  
mtext(text = "par(mar=c(5,4,4,2) + 0.1)", side=3, line=1, cex=1, col="green")  
mtext(text = "Line 0", side=3, line=0, adj=1.0, cex=1, col="green")  
mtext(text = "Line 1", side=3, line=1, adj=1.0, cex=1, col="green")  
mtext(text = "Line 2", side=3, line=2, adj=1.0, cex=1, col="green")  
mtext(text = "Line 3", side=3, line=3, adj=1.0, cex=1, col="green")  
mtext(text = "Line 0", side=2, line=0, adj=1.0, cex=1, col="green")  
mtext(text = "Line 1", side=2, line=1, adj=1.0, cex=1, col="green")  
mtext(text = "Line 2", side=2, line=2, adj=1.0, cex=1, col="green")  
mtext(text = "Line 3", side=2, line=3, adj=1.0, cex=1, col="green")  
...
# margins.  
mtext(text = "Outer Margin Area", side=1, line=1, cex=2, col="blue", outer=TRUE)  
mtext(text = "par(oma=c(3,3,3,3))", side=1, line=2, cex=1, col="blue", outer=TRUE)  
mtext(text = "Line 0", side=1, line=0, adj=0.0, cex=1, col="blue", outer=TRUE)  
mtext(text = "Line 1", side=1, line=1, adj=0.0, cex=1, col="blue", outer=TRUE)  
mtext(text = "Line 2", side=1, line=2, adj=0.0, cex=1, col="blue", outer=TRUE)  
