...
#tf_downstream_Pdgfrb %>% distinct(ENTREZID, SYMBOL) %>% write.csv(file = "../res/kv4.3_tf.csv")
```
...
p7 <- pathways %>% 
    dplyr::filter(from %in% o6)


filtered_path <- rbind(p1, p2, p3, p4, p5, p6, p7)
```
