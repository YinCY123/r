...
filtered_path <- rbind(o1, o2, o3, o4, o5, o6, o7, o8, o9)
...
A14_DEG_ENTREZ <- mapIds(org.Mm.eg.db, keys = A14_DEG, keytype = "SYMBOL", column = "ENTREZID")
...
DEG_3_orders <- tg %>% 
  ...
  filter(.N()$name %in% intersect(mapIds(org.Mm.eg.db, as.character(A3_DEG), "ENTREZID", "SYMBOL"), 
