...
```{r}
GSE107585 <- fread("F:/GSE107585/GSE107585_Mouse_kidney_single_cell_datamatrix.txt.gz", 
                   sep = "\t")
GSE107585 %>% dim()
GSE107585[1:4, 1:4]
...
sce.kidney <- SingleCellExperiment(assays = list(counts = GSE107585), 
                                   rowData = rdata, 
                                   colData = cdata)

sce.kidney <- readRDS("F:/GSE107585/sce.kidney_GSE107585.rds")
sce.kidney <- computeSumFactors(sce.kidney, clusters = sce.kidney$cluster)
sce.kidney <- logNormCounts(x = sce.kidney)


saveRDS(sce.kidney, "F:/GSE107585/sce.kidney_GSE107585.rds")
```
