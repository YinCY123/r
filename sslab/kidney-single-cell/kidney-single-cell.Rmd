...
mexper <- tapply(assay(sce.kidney[rownames(sce.kidney) == "Cx3cl1", ], "logcounts"), sce.kidney$celltype, median, na.rm = T) %>% 
  sort(decreasing = T)
...
plotExpression(sce.kidney, 
               ...
               colour_by = "celltype", 
               ncol = 1) +
    scale_fill_discrete(name = NULL, type = c(brewer.pal(8, "Set1"), brewer.pal(8, "Dark2"))) +
