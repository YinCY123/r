...
**modify the value in place do not trigger the validity function**  
```{r}
...
- `getClass`: can be instance class or class itself.  
- `slot`: pass an instance of an class and an slot name while retrieve the content of the slot.  
