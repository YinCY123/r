...
If we want ot set attributes of objects when constructing them, we need to do a little more work than in S4. We cannot just use named arguments in the constructor; this call would give us an error.  
...
This is achieved through the active argument to R6Class. Here you can
provide a list of attributes, as for private and public, but these attributes should be functions, and they will define a value-like syntax for calling the functions.  
